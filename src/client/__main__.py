...
def main():
    ...
    parser.add_argument(
        "--url",
        default=os.environ.get("APP_API_URL", "").strip() or "http://localhost:8000/v1/api",
    ...
    parser.add_argument(
        "--system",
        default=os.environ.get("LLM_SYSTEM_PROMPT"),
    ...
    parser.add_argument(
        "--timeout",
        type=float,
        default=float(os.environ.get("LLM_TIMEOUT_S", "60")),
